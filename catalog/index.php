...
$sort1 = 'SORT';
$sort2 = 'name';
if (in_array($dir[2], ['frezy-kontsevye', 'frezy-spiralnye', 'frezy-almaznye', 'frezy-so-smennymi-nozhami', 'frezy-nasadnye'])) {
	$sort1 = 'PROPERTY_D';
	$sort2 = 'PROPERTY_I';
} elseif(in_array($dir[2], ['svyerla-i-zenkery'])) {
	$sort1 = 'PROPERTY_D';
	$sort2 = 'PROPERTY_B';
}
?>
<div class="container">
	...
	<?$APPLICATION->IncludeComponent("bitrix:catalog", "", array(
		...
		"DETAIL_SHOW_ANALOG" => "Y",
		"DETAIL_SHOW_RELATED" => "Y",
