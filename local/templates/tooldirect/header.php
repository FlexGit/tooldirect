    ...
    <div class="header">
        <div class="container">
            <div class="header__row">
                ...
                <a href="mailto:zakaz@tooldirect.ru" class="header__contact header__contact--email">
                    <span>zakaz@tooldirect.ru</span>
    ...
    <div class="menu">
        <div class="container">
            <div class="menu__row">
				...
				<div style="display: flex;"><a href="https://instagram.com/tooldirect?igshid=q6cqhf3vqdbk" target="_blank"><img src="/images/instagram.png" style="width:32px;height:32px;"></a></div>
